...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/cloudMusic/songSearchListPage.css"/>
    <script type="text/javascript" src="/jss/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="/jss/vue.js"></script>
    <script type="text/javascript" src="/jss/cloudMusic/songSearchResultPage.js"></script>
...
<input id="playListId" style="display: none;" title="${keyword}"/>
</body>
</html>
