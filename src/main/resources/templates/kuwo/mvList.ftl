...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/kuwo/mvList.css"/>
    ...
    <script type="text/javascript" src="/jss/kuwo/mvList.js"></script>
...
<div id="rooter">
    <ul class="tab">
        <li v-for="item,index in dataArray" :pid="item[1]" :class="index === currentPageIndex ? 'focus' : ''">
            <a v-html="item[0]" :href="'/kuwo/mvListPage/' + item[1]" target="_blank"></a>
        </li>
    </ul>
    <ul class="mvs">
