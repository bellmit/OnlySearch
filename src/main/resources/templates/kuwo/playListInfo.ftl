...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/kuwo/playListInfo.css"/>
    <script type="text/javascript" src="/jss/jquery-3.3.1.min.js"></script>
    <script type="text/javascript" src="/jss/vue.js"></script>
    <script type="text/javascript" src="/jss/kuwo/playListInfo.js"></script>
...
<div id="rooter">
    <ul class="centerArea">
        <li class="leftArea">
            <img :src="albumInfos.img700"/>
            <h2>专辑简介</h2>
            <div v-html="albumInfos.info"></div>
        </li>
        <li class="rightArea">
            <h2 v-html="albumInfos.name"></h2>
            <p v-html="albumInfos.userName"></p>
...
<input style="display: none;" title="${pid}" id="pid"/>
